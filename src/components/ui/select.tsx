...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-md px-3 py-2 text-base",
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        "border-2 border-black bg-white text-black shadow-[4px_4px_0_0_#000000]",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "focus:bg-[#FFEB3B] focus:text-black",
      "hover:bg-[#FDD835] hover:text-black",
      className
    )}
    {...props}
  >
